...
datos_filtrados <- datos %>%
  ...
  group_by(location) %>%
  mutate(muertes_por_millon_7dias_media = rollmean(new_deaths_smoothed_per_million, 7, fill = NA, align = 'right'))  # Asegúrate de que el nombre de la columna sea correcto
